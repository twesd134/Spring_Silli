...
$(document).ready(function(){
	...
	<c:forEach var="obj" items="${faile.re_faile}" varStatus="status" >
		...
		if(answer!=ans)
		 {
			...
			const all={question:question,category:category};
			$.ajax({
	    		url : "faile_delete.do",
	    		type : "get",
	    		data:all,
...
<div class="container" style="margin-top:100px">
	<div class="card shadow">
		...
		<table id="tbl1">
		<li>${fn:length(faile.re_faile)} 문제 남았습니다</li>
		...
		<c:choose>
			<c:when test = "${fn:length(faile.re_faile) eq 0}">
			<li>문제를 다 푸셨습니다</li> 
