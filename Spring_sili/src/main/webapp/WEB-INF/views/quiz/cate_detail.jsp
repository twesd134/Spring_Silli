    ...
    var del = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                alert("삭제완료");
                location.href = "${root}cate_detail.do?category="+category;
            },
            error: function (data) {
        ...
        <div class="card shadow">
            <div class="card-body" id="view">
                ...
                <table id="tbl1">
                    ...
                    <c:forEach var="obj" items="${cate_detail.cate_detail}" varStatus="status">
                        ...
                        <div class="form-group" id="title_l">
                            ...
                            <input type="text" name="category" id="category" value="${obj.category}" />
                        </div>
                    </c:forEach>
                </table>
            </div>
